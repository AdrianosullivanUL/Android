...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPlayerNameTextView = findViewById(R.id.player_name_textview);
        mJerseyNumberTextView = findViewById(R.id.jersey_number_textview);
    ...
    private void ChangeJersey() {
        mPlayerNameTextView.setText(mJersey.getPlayerName().toString());
    ...
    private void resetJersey() {
        ...
        builder.setMessage("Are you sure you wish to undo?");
